					...
					<div class="col-lg-6 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<h3>회원 수정</h3>
								<br>
								<form action="memberUpdate" method="post" class="forms-sample">
									<!-- form-group -->
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" name="password" class="form-control" id="test05" value="${info.password}">
										</div>
									</div>
									<!-- //form-group -->
									<!-- form-group -->
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" name="phone" class="form-control" id="test02" value="${info.phone}">
										</div>
									</div>
									<!-- //form-group -->
									<!-- form-group -->
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" name="birthd" class="form-control" id="test03" value="${info.birthd}">
										</div>
									</div>
									<!-- //form-group -->
									<!-- form-group -->
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" name="point" class="form-control" id="test04" value="${info.point}">
										</div>
									</div>
									<!-- //form-group -->
